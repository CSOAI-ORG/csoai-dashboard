        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card className="p-5 border-amber-200 dark:border-amber-900">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">Runtime. 271 MCPs. Care-gated agents, BFT council, watermarking, attestation, prompt-injection firewall.</p>
